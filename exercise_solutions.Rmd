...
file_name <- list.files('.') %>%
  sort %>% 
  grep("(exercise_[0-9]_solution.html|exercise_[0-9]_alternative_solution.html)", . , value=TRUE) %>%
  .[c(1,2,3,5,4,6,7)]
...
knitr::purl('./exercise_4_alternative_solution.Rmd', output = './exercise_solutions/exercise_4_alternative_solution.R', quiet = TRUE)

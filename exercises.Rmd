...
[Exercise 5: Basic statistics in R](exercise_5.html)

[Exercise 6: Basic programming in R](exercise_6.html)
...
rmarkdown::render("exercise_5.Rmd", output_format = "pdf_document", output_file = "./exercises/exercise_6.pdf", quiet = TRUE)

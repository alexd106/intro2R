...
if (!file.exists("exercise_solutions/all_Rcode.zip")) system("rm exercise_solutions/all_Rcode.zip ; zip -r exercise_solutions/all_Rcode.zip exercise_solutions -x '*.html' -x '*.DS_Store' -x '*.R'")
```

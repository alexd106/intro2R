...
Alternative solutions to Exercise 4 for those who use (or are interested in using) the ```ggplot``` approach to plotting data. Courtesy of [Deon Roos](People.html).
